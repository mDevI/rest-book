...
public class RestBookApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        bookRepository.save(new Book("9740526698316", "Enim ullamco exercitation mollit cillum", "History", "Leona Sears"));
        bookRepository.save(new Book("9319330906092", "Aliqua aliqua minim Lorem consectetur", "Fiction", "Gale Bush"));
        bookRepository.save(new Book("9941209504915", "Lorem duis incididunt dolor est", "Art", "Horton Walker"));
        bookRepository.save(new Book("9941209504915", "Lorem duis incididunt dolor est", "Art", "Horton Walker"));
        bookRepository.save(new Book("9941209504915", "Lorem duis incididunt dolor est", "Art", "Horton Walker"));
        bookRepository.save(new Book("9941209504915", "Lorem duis incididunt dolor est", "Art", "Horton Walker"));
        bookRepository.save(new Book("9941209504915", "Lorem duis incididunt dolor est", "Art", "Horton Walker"));
